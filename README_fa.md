...
### 🚀نصب آسان
میتوانید به سادگی فایل `StartWindows.bat` یا `StartMacLin.sh` را (با توجه به سیستم عامل خود) از قسمت [RELEASES](https://github.com/AliNajafpour/tablokhan-ocr/releases) اجرا کرده، و با دنبال کردن مراحل، منتظر اجرای تابلوخوان باشید و  پس از اتمام کار مستقیما به قسمت ***استفاده از تابلوخوان*** بروید.
