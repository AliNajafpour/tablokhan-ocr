...
### Easy start 🚀
You can simply download the `StartWindows.bat` or `StartMacLin.sh` (depending on your operating system) file from [RELEASES](https://github.com/AliNajafpour/tablokhan-ocr/releases) and jump to **Usage**.
